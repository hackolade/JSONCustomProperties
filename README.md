...
<span class="rvts6">- container means: dbs in MongoDB, region in DynamoDB, bucket in Couchbase, and group in JSON</span>

<span class="rvts6">- entity means: collection in MongoDB, table in DynamoDB, document kind in Couchbase, document in JSON</span>

<span class="rvts6">- field means: field in MongoDB and Couchbase, attribute in DynamoDB, field in JSON</span>
